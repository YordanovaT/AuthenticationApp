...
class RegistrationView(View):
    ...
    def post(self, request):
        ...
        messages.add_message(request, messages.SUCCESS,
                             'Account successfully created! A confirmation email has been sent to you.') # pylint: disable=line-too-long
...
class HomeView(View):
    """Class view that is used for the home page """
    def get(self, request):
...
class RessetPasswordRequest(View):
    ...
    def post(self, request):
        ...
        if user.exists():  # send email only to users who have an account
            ...
            messages.add_message(request, messages.SUCCESS,
                                 'We have sent an email with instructions on how to reset you password.') # pylint: disable=line-too-long
        if context['has_error']:
            return render(request, 'authentication_app/request_reset_email.html',
...
class SetNewPass(View):
    ...
    def post(self, request, uidb64, token):
        ...
        try:
            ...
            messages.add_message(request, messages.SUCCESS,
                                 'You have successfully reset your password! You can login with the new password.')  # pylint: disable=line-too-long
